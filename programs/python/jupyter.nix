...
in
{
  home.file.".jupyter/startup.py".source = ./jupyter-startup.py;
  home.file.".jupyter/jupyter_notebook_config.py".text = lib.strings.concatStringsSep "\n" [
    ...
    ## file to open with jupyter -- usually added by the command line
    ...
    ''c.NotebookApp.password = "${secrets.jupyter.password}"''
    ...
    #  RECOMMENDED.
    "c.NotebookApp.token = '${secrets.jupyter.token}'"
