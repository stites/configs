...
let
  ...
  data-home = "${homedir}/.local/share/";
  log-dir = "glirc/irclogs";
in
{
  xdg.dataFile."${log-dir}/.emptyfile".text = "";
  xdg.configFile."glirc/config".text = lib.strings.concatStringsSep "\n" [
    ...
    defaults:
      ...
      realname:        "stites"
      tls:             yes-insecure
      tls-client-cert: "${pkgs.cacert}/etc/ssl/certs/ca-bundle.crt"
      tls-client-key:  "${pkgs.cacert}/etc/ssl/certs/ca-bundle.crt"
      log-dir:         "${data-home + log-dir}"
    ''
    ...
    servers:
      ...
      * name: "freenode"
        ...
        sasl-username: "stites"
        sasl-password: "${secrets.irc.freenode.password}"
